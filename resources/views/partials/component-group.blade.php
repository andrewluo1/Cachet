...
<ul class="list-group components">
    <li class="list-group-item group-name" style="background-color:#e8e8e8">
        <i class="{{ $componentGroup->collapse_class }} group-toggle"></i>
        <strong>{{ $componentGroup->name }}</strong>
@else
<ul class="list-group-item components" style="padding:1px 0px 0px 50px; font-size:13px;">
    <li class="list-group-item group-name" style="background-color:#f2f2f2">
        <i class="{{ $componentGroup->collapse_class }} group-toggle"></i>
        {{ $componentGroup->name }}
@endif
